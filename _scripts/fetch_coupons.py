...
# Conteggio tracking affiliate: coupon totali vs quanti sono caduti sul
...
def resolve_affiliate_url(raw: dict) -> str:
    """URL affiliate del coupon: usa promotion_link (tracciato) se presente,
...
def tracking_summary() -> None:
    """Stampa un riepilogo se almeno un coupon e' caduto sul fallback non
